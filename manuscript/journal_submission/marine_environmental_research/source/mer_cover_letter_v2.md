...
Privacy-safe aggregate data, code, specifications, and provenance are available at https://github.com/JTDingwall/herring-x-ebird-version-2. Restricted eBird records and protected row-level derivatives cannot be redistributed; the manuscript explains the source-access route and reconstruction requirements. No production response model or protected sensitivity was rerun for manuscript preparation, no statistical estimate changed, and no frozen analysis artifact was altered.
