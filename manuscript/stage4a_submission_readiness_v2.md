...
- Analysis freeze: `c54b8e7f95a2fe3573e2e38633079cd223c5a783` (`stage4a-publication-v2-analysis-freeze`)
- Abstract word count: 276
- Main-text word count (Introduction through Conclusions): 3944
- Main figures/tables: 5 / 3
- Supplementary figures/tables: 4 / 10
- Claim robustness counts: robust=11; supported with qualification=7; not estimable=1; unsupported=1
- Headline claims involving singular components: 3
