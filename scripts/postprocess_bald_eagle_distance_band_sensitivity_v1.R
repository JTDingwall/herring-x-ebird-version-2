...
code_files <- c(
  ...
  "scripts/postprocess_bald_eagle_distance_band_sensitivity_v1.R"
)
dirty <- system2(
  "git",
...
effects_path <- file.path(
  output_dir, "bald_eagle_distance_band_effects_v1.csv"
)
...
post_stage4a_plot_bald_eagle_distance_bands_v1(
  effects,
  file.path(output_dir, "bald_eagle_distance_band_panel_v1.png")
)
...
message("BALD_EAGLE_DISTANCE_BAND_POSTPROCESS=PASS")
