...
from edits_v40 import EDITS

SRC = "/sessions/keen-confident-allen/mnt/outputs/mer_manuscript_v39.docx"
OUT = "/sessions/keen-confident-allen/mnt/outputs/mer_manuscript_v40.docx"
...
shutil.move(tmp, OUT)
json.dump(target, open("v40_target.json", "w"))
