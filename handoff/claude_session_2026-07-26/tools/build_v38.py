...
from edits_v38 import EDITS

SRC = "/sessions/keen-confident-allen/mnt/outputs/mer_manuscript_v37.docx"
OUT = "/sessions/keen-confident-allen/mnt/outputs/mer_manuscript_v38.docx"
...
shutil.move(tmp, OUT)
json.dump(target, open("v38_target.json", "w"))
